...
OUTGOING_DATABASE_URL = _env("OUTGOING_DATABASE_URL", f"sqlite:///{(DATA_DIR / 'ai_voice_outgoing.db').as_posix()}")
...
AGENT_DEBUG_LOG_PATH = _env("AGENT_DEBUG_LOG_PATH", "/home/rei/apps/livekit-agent/runtime/active_call_debug.log")
...
LIVEKIT_OUTGOING_SIP_URI = _env("LIVEKIT_OUTGOING_SIP_URI")
LIVEKIT_OUTGOING_SIP_USERNAME = _env("LIVEKIT_OUTGOING_SIP_USERNAME")
LIVEKIT_OUTGOING_SIP_PASSWORD = _env("LIVEKIT_OUTGOING_SIP_PASSWORD")
TELNYX_API_KEY = _env("TELNYX_API_KEY")
TELNYX_API_BASE_URL = _env("TELNYX_API_BASE_URL", "https://api.telnyx.com/v2")
TELNYX_VOICE_WEBHOOK_PATH = _env("TELNYX_VOICE_WEBHOOK_PATH", "/telnyx/voice-webhook")
TELNYX_OUTGOING_WEBHOOK_PATH = _env("TELNYX_OUTGOING_WEBHOOK_PATH", "/outgoing/telnyx/webhook")
...
DEFAULT_ASSISTANT_LANGUAGE = _env("DEFAULT_ASSISTANT_LANGUAGE", "en")
...
DEFAULT_TTS_SPEED = float(_env("DEFAULT_TTS_SPEED", "1.0") or "1.0")
